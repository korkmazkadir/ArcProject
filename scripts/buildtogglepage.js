...
function createToggleCell(row, type, toggleCount, h_count, sTxt, excluded, lastRowIsOdd) {
	...
	t_createCell(row, type, classOfTheCell, 0, 0, celltxt, lnktxt, relAtt, alignTxt, styleTxt, 0, 0, sTxt);
	return;
};
//////////////////////////////////////////////////////////////////////////////////////////
	...
	for (; t < divObj.childNodes.length ; t++) {
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////		
			if (columnSpan != 9) { /* i.e. columnSpan == 2 or 1 */
				createToggleCell(newRow, 'TD', 'LH', 'h1', 0, excluded, lastRowOdd);
				createToggleCell(newRow, 'TD', 'HL', 'h2', 0, excluded, lastRowOdd);
				createToggleCell(newRow, 'TD', 'LZ', 'h3', newRow.getAttribute('s1'), excluded, lastRowOdd);
				createToggleCell(newRow, 'TD', 'ZH', 'h4', newRow.getAttribute('s2'), excluded, lastRowOdd);
				createToggleCell(newRow, 'TD', 'HZ', 'h5', newRow.getAttribute('s3'), excluded, lastRowOdd);
				createToggleCell(newRow, 'TD', 'ZL', 'h6', newRow.getAttribute('s4'), excluded, lastRowOdd);
